...
void _ui_screen_change_by_index(uint8_t index) {
  ...
  case 0:
    ...
    break;
  case 1:
    _ui_screen_change(&ui_corriente, UI_ANIM_SWIPE_UP, UI_ANIM_SWIPE_DURATION,
                      UI_ANIM_SWIPE_DELAY, &ui_corriente_screen_init);
    break;
  case 2:
    _ui_screen_change(&ui_dashboard, UI_ANIM_SWIPE_UP, UI_ANIM_SWIPE_DURATION,
  ...
  case 3:
    ...
    break;
  case 4:
    _ui_screen_change(&ui_voltageStats, UI_ANIM_SWIPE_UP,
                      UI_ANIM_SWIPE_DURATION, UI_ANIM_SWIPE_DELAY,
