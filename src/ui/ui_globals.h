...
/** Fondo semi-transparente del overlay de modales */
#define UI_COLOR_MODAL_OVERLAY lv_color_hex(0x000000)
#define UI_OPA_MODAL_OVERLAY 180

/** Fondo de tarjetas / paneles de modal */
#define UI_COLOR_CARD_BG lv_color_hex(0x1A1A1A)

/** Color del botón Cancelar */
#define UI_COLOR_BTN_CANCEL lv_color_hex(0x3A3A3A)

/** Fuente para labels de la pantalla config */
#define UI_FONT_CONFIG_TITLE (&ui_font_Qualy28)
#define UI_FONT_CONFIG_LABEL (&ui_font_Qualy24)
#define UI_FONT_CONFIG_SMALL (&ui_font_Qualy14)
#define UI_FONT_CONFIG_BTN (&ui_font_Qualy14)

/** Valor por defecto del brillo (0–255) */
#define UI_BRIGHTNESS_DEFAULT 200

/** Track del slider de brillo */
#define UI_COLOR_SLIDER_TRACK lv_color_hex(0x2A2A2A)
